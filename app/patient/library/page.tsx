          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <button
                ...
                className="relative overflow-hidden rounded-[32px] p-8 shadow-sm hover:shadow-md hover:scale-[1.01] transition-all flex flex-col text-left group min-h-[240px] bg-gradient-to-br from-[#3b82f6] to-[#14b8a6] text-white"
              >
              ...
              <button
                ...
                className="relative overflow-hidden rounded-[32px] p-8 shadow-sm hover:shadow-md hover:scale-[1.01] transition-all flex flex-col text-left group min-h-[240px] bg-gradient-to-br from-[#f07865] to-[#faba75] text-white"
              >
              ...
              <button
                ...
                className="relative overflow-hidden rounded-[32px] p-8 shadow-sm hover:shadow-md hover:scale-[1.01] transition-all flex flex-col text-left group min-h-[240px] bg-gradient-to-br from-[#0d9488] to-[#4f46e5] text-white"
              >
                <svg className="absolute inset-0 w-full h-full opacity-15 pointer-events-none" viewBox="0 0 400 200" fill="none" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button
                ...
                className="relative overflow-hidden rounded-[32px] p-8 shadow-sm hover:shadow-md hover:scale-[1.01] transition-all flex flex-col text-left group min-h-[240px] bg-gradient-to-br from-[#6366f1] to-[#a855f7] text-white"
              >
                <svg className="absolute inset-0 w-full h-full opacity-20 pointer-events-none" viewBox="0 0 400 200" fill="none" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button
                ...
                className="relative overflow-hidden rounded-[32px] p-8 shadow-sm hover:shadow-md hover:scale-[1.01] transition-all flex flex-col text-left group min-h-[240px] bg-gradient-to-br from-[#059669] to-[#34d399] text-white"
              >
                <svg className="absolute inset-0 w-full h-full opacity-15 pointer-events-none" viewBox="0 0 400 200" fill="none" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button
                ...
                className="relative overflow-hidden rounded-[32px] p-8 shadow-sm hover:shadow-md hover:scale-[1.01] transition-all flex flex-col text-left group min-h-[240px] bg-gradient-to-br from-[#db2777] to-[#fb7185] text-white"
              >
                <svg className="absolute inset-0 w-full h-full opacity-15 pointer-events-none" viewBox="0 0 400 200" fill="none" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
