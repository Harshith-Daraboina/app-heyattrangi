    ...
    return (
        <div className="hidden xl:flex flex-col w-[340px] bg-white h-full px-8 py-10 relative">
            <div className="flex items-center justify-between mb-8">
                <h3 className="text-lg font-bold text-gray-900">List of appointments</h3>
            </div>
                    ...
                    {daysInMonth.map((date, i) => {
                      ...
                      `}
                                ...
                                {hasAppointment && !isSelected && (
                                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full bg-orange-400/80" />
                                )}
                            </div>
                        )
                    })}
